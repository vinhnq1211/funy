...
include_once( TP_THEME_DIR . '/inc/widgets/client-logo/client-logo.php' );
...
include_once( TP_THEME_DIR . '/inc/widgets/slider-images/slider-images.php' );
include_once( TP_THEME_DIR . '/inc/widgets/counters-box/counters-box.php' );
include_once( TP_THEME_DIR . '/inc/widgets/feature-box/feature-box.php' );
include_once( TP_THEME_DIR . '/inc/widgets/features-list/features-list.php' );
include_once( TP_THEME_DIR . '/inc/widgets/share-social/share-social.php' );
include_once( TP_THEME_DIR . '/inc/widgets/copyright/copyright.php' );
include_once( TP_THEME_DIR . '/inc/widgets/button/button.php' );
include_once( TP_THEME_DIR . '/inc/widgets/accordion/accordion.php' );
include_once( TP_THEME_DIR . '/inc/widgets/loginout/loginout.php' );
// Add widget Events
if (class_exists('TP_Event')) {
	include_once( TP_THEME_DIR . '/inc/widgets/events/events.php' );
}

if (class_exists('our_team_metabox')) {
	include_once( TP_THEME_DIR . '/inc/widgets/team/team.php' );
}
if (class_exists('testimonials_metabox')) {
	include_once( TP_THEME_DIR . '/inc/widgets/testimonials/testimonials.php' );
}
if (class_exists('woocommerce')) {
	include_once( TP_THEME_DIR . '/inc/widgets/woo-box/woo-box.php' );
}
if (class_exists('wpdoc')) {
	include_once( TP_THEME_DIR . '/inc/widgets/document/document.php' );
}
if (class_exists('WP_Job_Manager')) {
	include_once( TP_THEME_DIR . '/inc/widgets/list-job/list-job.php' );
}
