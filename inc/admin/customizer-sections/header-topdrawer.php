...
$header->createOption( array(
	'name'    => __( 'Show or Hide Drawer', 'mabu' ),
	'id'      => 'show_drawer',
	'type'    => 'checkbox',
	"desc"    => "show/hide",
	'default' => false,
...
$header->createOption( array(
	'name'        => __( 'Drawer Background color', 'mabu' ),
	'id'          => 'bg_drawer_color',
	'type'        => 'color-opacity',
	'default'     => '#ffffff',
...
$header->createOption( array(
	'name'        => __( 'Drawer Text color', 'mabu' ),
...
$header->createOption( array(
	'name'    => __( 'Drawer Open or Close', 'mabu' ),
	'id'      => 'drawer_open',
	'type'    => 'checkbox',
	"desc"    => "open/close",
	'livepreview' => '
